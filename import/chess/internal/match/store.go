...
func (s *Store) statePath() string {
	return filepath.Join(s.Root, ".chess", "run", "state.json")
}

func (s *Store) statusPath() string {
	return filepath.Join(s.Root, ".chess", "status.json")
}

func (s *Store) lockPath() string {
	return filepath.Join(s.Root, ".chess", "run", "lock")
}

func (s *Store) playbookDir() string {
	return filepath.Join(s.Root, ".chess", "playbook")
}
