---
name: arbiter-play
description: 按既定流程棋谱执行任务。当用户要求"按流程/规范/playbook 办事",或要求执行 .arbiter/match/playbook 中定义的某类工作时使用。
---
...
- 不读取、不猜测 .arbiter/match/playbook 与 .arbiter/match/run 的内容;你对流程的全部认知
  来自 ShowStepJob。
